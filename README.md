...
- Читаю и анализирую код (C#, TypeScript, React, 1C), проектирую базы данных, HLA.
...
- Разрабатываю концепты интерфейсов (Figma, Adobe) и кликабельные прототипы на React (при помощи ИИ). <br> _Если интересно, посмотрите [мое дизайн-портфолио](https://www.behance.net/kuzz_design_art)._
