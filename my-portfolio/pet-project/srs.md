...
Подробное описание проекта доступно в Vision & Scope, в рамках которого в разделе «Масштабы и ограничения проекта» перечислены функции, которые запланированы для полной или частичной реализации в релизах.

### 2.3. Основные функции системы
Основные функции Системы зафиксированы в Vision & Scope.
...
#### 3.2.2. Зависимости
Зависимость Системы от других сервисов/проектов приведена в п. 3.3 Vision & Scope.
