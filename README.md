...
Меня зовут Виктория Ковалева, и в настоящий момент я являюсь **<mark>System Analyst</mark>** и **<mark>Technical Writer</mark>** в компании **Lesta Games**.
> В **Lesta Games** я работаю над проектом [**BASE**](https://baseplatform.online/ru/games) - платформой, на которой уже представлены игры компании, включая "Мир Кораблей". **BASE** позволяет пользователям со всего мира запускать игры, покупать внутриигровые товары и следить за новостями полюбившихся тайтлов.
...
- Читаю и анализирую код (C#, React, 1C), проектирую базы данных, контракты обмена данными, верхнеуровневую архитектурау (HLA).
...
- 👯 Сейчас работаю в одной команде с `Development`, `QA`, `Product Managers`, `Business Analyst`, `Design`.
- 🌱 Часто взаимодействую со смежными специалистами: `Support`, `DevOps`, `Release & Maintenance`, `Publishing`, `Legal`, `Architecture`.<br>_Бывали задачи, где требовалось согласование ТЗ с `военной приемкой`._
